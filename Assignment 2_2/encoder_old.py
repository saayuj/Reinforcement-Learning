                    ...
                    for k in range(3):
                        if k == 0:
                            ...
                            if i <= 160:
                                ...
                                reward = 0
                                file.write('transition ' + str(i) + ' ' + str(k) + ' ' + str(i - 10 - 150) + ' ' + str(reward) + ' ' + str(P_B[k]) + '\n')
                        else:
                            if i <= 160:
                                if k - 1 < i:
                                    reward = 0
                                ...
                                if i % 10:
                                    if k - 1 < (i % 10):
                                        runs_left = (i % 10) - k + 1
                                        reward = 0
                                        file.write('transition ' + str(i) + ' ' + str(k) + ' ' + str(i - 10 - (i % 10) + runs_left) + ' ' + str(reward) + ' ' + str(P_B[k]) + '\n')
                                    else:
                                        reward = 1
                                        file.write('transition ' + str(i) + ' ' + str(k) + ' ' + str(301) + ' ' + str(reward) + ' ' + str(P_B[k]) + '\n')
                                else:
                                    runs_left = 10 - k + 1
                                    reward = 0
                                    file.write('transition ' + str(i) + ' ' + str(k) + ' ' + str(i - 20 + runs_left) + ' ' + str(reward) + ' ' + str(P_B[k]) + '\n')
                else:
                    for k in range(3):
                        if k == 0:
                            reward = 0
